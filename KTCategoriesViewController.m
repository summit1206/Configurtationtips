...
-(void)PromptShowAlertBuyTip{
    UIAlertController *alertShow =[UIAlertController alertControllerWithTitle:@"Prompt" message:@"The current version of 66 tips is completely free" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *sure = [UIAlertAction actionWithTitle:@"Sure" style:UIAlertActionStyleDefault handler:nil];
    [alertShow addAction:sure];
